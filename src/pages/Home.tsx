        ...
        >
          ...
          >
            <img 
              src="/logo.png" 
              alt="Forge Logo" 
              className="w-full h-full object-contain p-8 md:p-16 grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-1000"
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs font-bold text-forge-teal-light mb-1">Success Automation</p>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
              {features.map((feature, index) => (
                ...
                >
                  <div className="text-[10px] font-mono text-white/20 absolute -top-4 left-0">Module {feature.id}</div>
