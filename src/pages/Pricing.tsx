...
const Pricing = () => {
  const tiers = [
    {
      name: "Forge Web Design",
      price: "$500",
      pricePrefix: "from",
      description: "High-performance digital architectures designed to convert visitors into loyal customers, from simple landing pages to complex ecosystems.",
      features: [
        "Professional UI/UX Design",
        "Mobile & Tablet Optimization",
        "Strategic Page Architecture",
        "SEO & Performance Tuning",
        "CMS or E-commerce Ready",
        "Advanced Analytics Setup",
        "Dedicated Refinement Cycles"
      ],
      highlight: false,
      link: "/starter-forge-options"
    },
    {
      name: "Forge Brand Design",
      price: "$100",
      pricePrefix: "from",
      ...
      features: [
        ...
        "Social Media & Business Assets",
        "Full Production File Kits"
      ],
      highlight: true,
      link: "/brand-forge-options"
    },
    {
      name: "Forge Custom",
      price: "Custom",
      description: "A comprehensive, tailor-made fusion of high-performance web development and strategic brand identity, architected specifically for your business goals.",
      features: [
        "Everything in Web & Brand Design",
        "Fully Bespoke Visual Identity",
        "Custom Scalable Web Ecosystem",
                ...
                {tier.features.map((feature, fIndex) => (
                  <li key={fIndex} className="flex flex-col gap-1">
                    <div className="flex items-center gap-3 text-sm font-bold uppercase tracking-tight">
                      <CheckCircle2 className="w-5 h-5 shrink-0 text-forge-teal" />
                      <span>{feature}</span>
                    </div>
                  </li>
                ))}
