        ...
        <div className="glass-card rounded-[3rem] shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-white/10 relative">
          ...
          <div className="lg:w-5/12 p-12 md:p-16 bg-white/[0.02] text-white relative border-r border-white/10">
            ...
            <div className="space-y-12">
              <a href="mailto:receptai.help@gmail.com" className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white group-hover:text-forge-teal transition-colors">receptai.help@gmail.com</p>
                </div>
              </a>
          ...
          <div className="lg:w-7/12 p-12 md:p-16 relative">
            <div className="absolute top-0 right-0 p-4 font-bold text-[9px] text-white/10 uppercase tracking-widest hidden md:block">Refinement 2.0</div>
